...
class UserPlaceProviderNotifier extends StateNotifier<List<PlaceModel>>{
  ...
  void addPlaceUserProvider(String title){
    ...
    state = [...state,newPlace];// ...state this will update the state and not delete the old data
  }
}

final userPlaceProvider = StateNotifierProvider((ref) => UserPlaceProviderNotifier(),);